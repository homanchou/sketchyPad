...
(function() {
  var SketchController, SketchData, SketchListener, SketchStroke, SketchView, addCurveSegment, distance, distortPoints, root, slope, smoothConfig,
  ...
  SketchController = (function() {
    ...
    SketchController.prototype.process_mouse_up = function() {
      ...
      return this.strokeData = new SketchStroke();
    };
